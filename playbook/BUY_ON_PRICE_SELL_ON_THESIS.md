...
**작성일**: 2026-05-03 (v2: 2026-05-03 — 안전마진 정의 명확화 + 경주산 소시지 + Wonderful 정량 정의 + 확증편향 추가)
...
| Conviction | 단일 종목 max 비중 |
| --- | --- |
| High (deep dive 통과 + Wide moat) | **25-30%** |
| Medium (shallow dive 통과) | **10-15%** |
| Low (관심 watch) | **3-5%** |

비중 limit 초과 시 **자동 trim** (사업과 무관, 순수 risk management).
