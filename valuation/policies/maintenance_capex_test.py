...
class TestAvgCapex:
  """Tests for AvgCapex policy (weighted yearly average)."""
  ...
  def test_weighted_avg_3y(self):
    ...
    quarters = _make_quarters(
        ...
        capex_ttm_values=[10.0] * 4 + [20.0] * 4 + [30.0] * 4 + [40.0] * 4,
    ...
    assert result.diag['maint_capex_method'] == 'weighted_avg_3y'
